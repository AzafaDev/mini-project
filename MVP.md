...
Clues:
Voucher Discount: This is provided by the event organizer and can only be used for specific events organized by them.
Reward / Coupon Discount: This is provided by the application system and can be used for all events.
